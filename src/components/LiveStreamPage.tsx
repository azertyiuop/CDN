...
import { StreamSource, ChatMessage } from '../types';
...
export default function LiveStreamListPage({ currentUser, onBack, chatMessages = [], wsService }: LiveStreamListPageProps) {
